/*
  ...
  - You are about to drop the column `updateddAt` on the `UpdatePoint` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "UpdatePoint" DROP COLUMN "updateddAt",
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
